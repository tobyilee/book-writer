...
그리고 운영자 입장에서 가장 어려운 자리. **새벽 3시 alert가 망분리 영역 안에서 떴을 때, 외부에서는 못 본다.** 9장의 secret rotation이 망 안과 밖 양쪽에서 일관되게 일어나야 한다. 14장의 관측성 도구가 망 양쪽에 모두 깔려야 한다. 작은 결정 하나가 운영의 모든 자리에 영향을 미친다.
