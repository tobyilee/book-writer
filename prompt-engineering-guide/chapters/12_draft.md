...
여기서 이 장의 핵심이 나온다. **품질 점수 하나만 보고 고르면, 거의 반드시 비싸고 느린 후보를 고르게 된다.** 추론을 더 쓰면 대개 품질이 조금 더 오르기 때문이다. 문제는 그 "조금"을 위해 치르는 대가다.
