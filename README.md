...
- **Repo:** https://github.com/tobyilee/book-writer (private)
...
저자 `Toby-AI`는 오케스트레이터 스킬과 `epub-builder` 에이전트에 고정되어 있다. 바꾸려면:
- `.claude/skills/book-writing-orchestrator/SKILL.md`의 메타데이터 섹션
- `.claude/agents/epub-builder.md`의 "저자는 반드시 `Toby-AI`" 문장
- `.claude/agents/editor.md`의 `book_manifest.json` 템플릿
